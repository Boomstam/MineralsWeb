...
public class BuildAutomation : Editor
{
    ...
    {
        SetConnectionType(ConnectionType.TugboatClient);
    ...
    private static void SetConnectionType(ConnectionType connType)
    {
        if(ConnectionTypeHolder.ConnectionType != connType)
            CreateConnectionTypeHolder(connType);
    }

    private static void CreateConnectionTypeHolder(ConnectionType connType)
    {
...
";
        scriptContent += $"public static ConnectionType ConnectionType = ConnectionType.{connectionTypeString};";
